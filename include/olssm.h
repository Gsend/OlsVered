...
OlsSMStatus olssm_modified_cholesky(const double *x,
                                    uintptr_t x_rows,
                                    uintptr_t x_cols,
                                    const double *y,
                                    double *c_out);
...
/// @return         OlsSMStatus::Ok on success
OlsSMStatus olssm_back_substitute(const double *c, uintptr_t dim, double *beta_out);
...
/// @return         OlsSMStatus::Ok on success
OlsSMStatus olssm_solve_ols(const double *x,
                            uintptr_t x_rows,
                            uintptr_t x_cols,
                            const double *y,
                            double *beta_out);
...
/// @return         OlsSMStatus::Ok on success
OlsSMStatus olssm_simplified_gram_schmidt(const double *x,
                                          uintptr_t x_rows,
                                          uintptr_t x_cols,
                                          double *q_out);
...
/// @return         OlsSMStatus::Ok on success
OlsSMStatus olssm_weighted_generalized_inverse(const double *x,
                                               uintptr_t x_rows,
                                               uintptr_t x_cols,
                                               const double *w,
                                               double *g_out);
