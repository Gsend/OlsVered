...
VERED_LR          = 1.0e-3  # backed off from 2e-2 — slow convergence at step 460 suggests still too high
...
def make_vered_kfac(model):
    ...
    return VeredKFAC(
        ...
        gamma=0.7,   # reduced from 0.9 — heavy smoothing was slowing R factor adaptation
    )
